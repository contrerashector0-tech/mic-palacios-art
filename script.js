...
const GALLERY = [
  {
    id: 1,
    title: 'La Catrina Eterna',
    category: 'Día de los Muertos',
    medium: 'Traditional media on canvas',
    description: 'A tribute to the iconic La Catrina figure, rendered in rich chiaroscuro with marigold florals against a deep midnight ground.',
    image: null,
    accent: '#e07820',
  },
  {
    id: 2,
    title: 'Shadow Bloom',
    category: 'Gothic Original',
    medium: 'Traditional media on canvas',
    description: 'Dark roses emerging from shadow — a meditation on beauty found in obscurity. Deep purple hues with gold leaf highlights.',
    image: null,
    accent: '#5c2d91',
  },
  {
    ...
    description: 'A richly detailed altar arrangement honoring ancestors — marigolds, candles, photographs, and calavera masks in the El Paso tradition.',
    image: null,
    accent: '#e07820',
  },
  {
    id: 4,
    title: 'Gothic Portrait No. 1',
    category: 'Gothic Original',
    medium: 'Traditional media on canvas',
    description: 'A brooding portrait study — heavy shadow work, minimal highlight, exploring the space between presence and absence.',
    image: null,
    accent: '#5c2d91',
  },
  {
    id: 5,
    title: 'Calavera de Amor',
    category: 'Día de los Muertos',
    medium: 'Traditional media',
    description: 'Sugar skull portrait overflowing with intricate floral details — roses, dahlias, and marigolds woven through the composition.',
    image: null,
    accent: '#c0396e',
  },
  {
    ...
    category: 'Fan Art',
    medium: 'Traditional media on canvas',
    description: 'A fan art commission rendered in Dark Shadows Art Studio's signature dark style — iconic character reimagined in gothic palette.',
    image: null,
    accent: '#c9a84c',
  },
  {
    id: 7,
    title: 'Portrait Commission I',
    category: 'Custom Portrait',
    medium: 'Traditional media',
    description: 'A custom commissioned portrait — subject captured in dramatic lighting with the distinctive high-contrast style of Dark Shadows Art Studio.',
    image: null,
    accent: '#a88a3a',
  },
  {
    id: 8,
    title: 'Noche de Flores',
    category: 'Día de los Muertos',
    medium: 'Traditional media on canvas',
    description: 'Night of flowers — vibrant marigolds and deep roses framing a calavera face, celebrating the border tradition of remembrance.',
    image: null,
    accent: '#e07820',
  },
  {
    ...
    category: 'Gothic Original',
    medium: 'Traditional media',
    description: 'An original dark portrait — the muse who visits at midnight, rendered in blacks, deep purples and a single gold highlight.',
    image: null,
    accent: '#5c2d91',
  },
  {
    id: 10,
    title: 'Fan Art — Tribute',
    category: 'Fan Art',
    medium: 'Traditional media on canvas',
    description: 'A pop culture tribute commission — bringing a beloved character into the Dark Shadows visual universe.',
    image: null,
    accent: '#c9a84c',
  },
  {
    id: 11,
    title: 'Portrait Commission II',
    category: 'Custom Portrait',
    medium: 'Traditional media',
    description: 'A custom portrait commission capturing personality through dramatic shadow and highlight — a unique one-of-a-kind piece.',
    image: null,
    accent: '#a88a3a',
  },
  {
    id: 12,
    title: 'Altar de Sombras',
    category: 'Día de los Muertos',
    medium: 'Traditional media on canvas',
    description: 'Altar of shadows — an oversized composition blending dark gothic atmosphere with the warm celebration of Día de los Muertos.',
    image: null,
    accent: '#c0396e',
  },
];
